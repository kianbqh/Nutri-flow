...
$masterLog = "$outRoot\stage6s6_resume_master.log"
$gateDecision = "$outRoot\stage6s6_gate_decision.json"

$phaseAOut = "$stage6s6Out\stage6s6_tiny_img512_phaseA_50ep"
$phaseBOut = "$stage6s6Out\stage6s6_tiny_img512_phaseB_30ep"
$phaseCOut = "$stage6s6Out\stage6s6_tiny_img512_phaseC_20ep"

$bestA = "$phaseAOut\best_stage6s6_tiny_img512_phaseA_50ep.pth"
$bestB = "$phaseBOut\best_stage6s6_tiny_img512_phaseB_30ep.pth"
$bestC = "$phaseCOut\best_stage6s6_tiny_img512_phaseC_20ep.pth"
...
$evalC = "$stage6s6EvalOut\stage6s6_eval_tiny_img512_phaseC_20ep_fullval\eval_summary.json"
...
"[$(Get-Date -Format o)] START Stage6S6 resume pipeline" | Out-File -FilePath $masterLog -Encoding UTF8 -Append
...
if (!(Test-Path $bestA)) {
    throw "Missing checkpoint: $bestA"
}
...
"[$(Get-Date -Format o)] ALL DONE Stage6S6 resume pipeline" | Out-File -FilePath $masterLog -Encoding UTF8 -Append
